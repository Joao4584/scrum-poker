...
export function DataTableEmptyState({ icon: Icon, title, description, children, disabledBackground }: DataTableEmptyStateProps) {
  return (
    <div
    ...
    >
      <div className={`relative flex h-[485px] w-full items-center justify-center ${disabledBackground! ?? "bg-background backdrop-blur-xl h-[325px]"} `}>
      ...
      <div className="mb-9 relative bottom-24 flex flex-col items-center gap-4">
