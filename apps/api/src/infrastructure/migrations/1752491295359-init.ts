...
export class Init1752491295359 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "room_participant" ("id" SERIAL NOT NULL, "uuid" character varying NOT NULL, "room_id" integer NOT NULL, "user_id" integer NOT NULL, "is_admin" boolean NOT NULL DEFAULT false, "joined_at" TIMESTAMP NOT NULL, "deleted_at" TIMESTAMP, CONSTRAINT "UQ_e1db258626cccd618e3e2c3e779" UNIQUE ("uuid"), CONSTRAINT "PK_f4e1d0fa763659c18b645646130" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "vote" ("id" SERIAL NOT NULL, "uuid" character varying NOT NULL, "question_id" integer NOT NULL, "user_id" integer NOT NULL, "value" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_4ae2a03b4f70762789eaaed3803" UNIQUE ("uuid"), CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "question" ("id" SERIAL NOT NULL, "uuid" character varying NOT NULL, "room_id" integer NOT NULL, "text" character varying NOT NULL, "revealed" boolean NOT NULL DEFAULT false, "is_active" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_6930ce56f7294538e3751b9f32a" UNIQUE ("uuid"), CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
